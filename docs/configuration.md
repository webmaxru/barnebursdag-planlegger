...
`ConfigEditor.tsx` renders every item as an expandable card with inputs for all of the above. Users can:
...
| Category | Items |
|----------|-------|
| Mat | Pølser, Lomper, Pølsebrød*, Bursdagskake, Frukt, Snacks |
| Drikke | Saft, Brus (7+) |
| Servise | Tallerkener, Kopper, Servietter, Bestikk, Bordduk, Sugerør* |
| Pynt | Ballonger, Bursdagskrone, Kakelys, Norske bordflagg, Vimpelrekke* |
| Godteri | Godteposer, Smågodt, Premier* |
